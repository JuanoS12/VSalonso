...
MQTT_PORT = 1883
MQTT_CLIENT_ID = 'ESP32_Motor2'
MQTT_USER = 'jair'  # MQTT user
MQTT_PASS = 'ola'    # MQTT passwordS
TOPIC_VIBE_M1 = 'Motor/vibe/M2'
TOPIC_TEMP_M1 = 'Motor/temp/M2'
TOPIC_CONTROL_M1 = 'Motor/control/M2'
TOPIC_CURRENT_M1 = 'Motor/curr/M2'
...
def loop(client, mpu):
    while True:
        ...
        adjusted_magnitude = (magnitude - RESTING_STATE_OFFSET)
